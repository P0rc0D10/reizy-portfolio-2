      ...
      <div className="md:flex">
        <div className="btn-group grid grid-cols-4 justify-between md:justify-start w-full md:mr-3 md:mb-0 mb-2">
          ...
          <svg
            ...
            strokeLinejoin="round"
          >
            <path d="M12 2C6.48 2 2 6.48 2 12c0 5.52 4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm4.93 14.07c-.39.39-1.02.39-1.41 0l-5.12-5.12c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.41 0l5.12 5.12c.39.39.39 1.02 0 1.41zm-6.36-6c-.39-.39-1.02-.39-1.41 0l-3.59 3.59c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0l3.59-3.59c.39-.39.39-1.02 0-1.41z"></path>
          </svg>
          </a>
          <a
            href="/youtube"
